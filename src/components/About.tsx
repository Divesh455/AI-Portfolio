...
export default function About() {
  return (
    <section id="about" className="relative py-24 bg-bg-dark overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          >
            {/* Capsule Badge */}
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-gold/35 bg-bg-card/35 text-gold text-[10px] font-mono tracking-widest uppercase w-max">
              About Me
            </div>
            ...
            <div className="space-y-6 text-[#9CA3AF] font-sans text-base md:text-[17px] leading-relaxed font-light">
              <p>
                I am an aspiring <span className="text-gold font-normal">AI Engineer</span> dedicated to building intelligent, AI-driven applications that solve real-world problems. Passionate about Machine Learning, Generative AI, and modern backend development, I enjoy transforming innovative ideas into scalable, production-ready solutions.
              </p>
              <p>
          ...
          >
            <div className="p-8 rounded-3xl border border-gold/10 bg-bg-card/15 backdrop-blur-md shadow-2xl relative overflow-hidden group hover:border-gold/25 transition-colors duration-500">
              {/* Subtle inner gold glow */}
              <div className="absolute top-0 right-0 w-[150px] h-[150px] rounded-full bg-gold opacity-[0.03] blur-[40px] pointer-events-none group-hover:opacity-[0.06] transition-opacity duration-500" />
              ...
              <div className="flex flex-col">
                {coreInterests.map((interest, index) => (
                  ...
                  >
                    <Activity className="w-4 h-4 text-gold shrink-0 opacity-80 group-hover/item:opacity-100 group-hover/item:scale-110 transition-all duration-300" />
